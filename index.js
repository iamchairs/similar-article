module.exports = (function() {
  ...
  var common = common200;

  var additions = {'id':true,'felt':true,'didnt':true,'wasnt':true,'knew':true,'likely':true,'took':true,'theyre':true,'both':true,'since':true,'an':true,'more':true,'often':true,'another':true,'has':true,'doesnt':true,'too':true,'been':true,'im':true,'hes':true,'had':true,'says':true,'i':true,'wont':true,'here':true,'were':true,'there':true,'each':true,'are':true,'is':true,'said':true,'was':true};
